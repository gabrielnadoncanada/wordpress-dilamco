<div class="section-hero hero-2 position-relative overflow-x-hidden max-width">
	<?php	
    $image_url = get_theme_file_uri('assets/images/space-hero-image.jpg');			
