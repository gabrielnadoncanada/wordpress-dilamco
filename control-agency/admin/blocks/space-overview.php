...
$block = [
    ...
    'icon'            => 'info-outline',
    'disable_block'   => true,
    'description'     => 'Display space overview',
    'fields'          => [
        [            
            'type' => 'hidden',
            'id' => 'template',
            'name' => 'Template',
            'std' => 'space/single/overview.php',            
        ],
        [
            'type'          => 'single_image',
            'id'            => 'image',
            'name'          => esc_attr__('Image', 'architronix'),
            'desc'          => esc_attr__('Displayed as a single space banner', 'architronix'),
            'max_file_uploads' => 1,
            'max_status'    => false,
            'image_size'    => 'full',
        ],        
        ...
        [
            ...
            'desc'          => sprintf(esc_attr__('Use %s, %s in description to get dynamic value from this space', 'architronix'), '<code>[space_types]</code> - <strong>Space Category</strong>', '<code>[collaborators]</code> - <strong>Space collaborators</strong>'),
            'std'         => [
                [
                    'title' => 'Clients:',
                    'desc' => 'Sogeprom',
