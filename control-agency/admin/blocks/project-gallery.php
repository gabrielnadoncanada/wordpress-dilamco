...
return [
    ...
    'fields'          => [
        [            
            ...
            'options' => [
                'project/single/media-isotope.php' => 'Grid',
                'project/single/media-carousel.php' => 'Carousel',
                'project/single/media-slider.php' => 'Slider',
            ] 
        ],
        [
            'id'               => 'gallery',
            'name'             => esc_attr__('Gallery images', 'architronix'),
            'desc'             => esc_attr__('Used for single project gallery inmages in content', 'architronix'),
            'type'             => 'image_advanced',
            'force_delete'     => false,
            'max_file_uploads' => 6,
            'max_status'       => true,
