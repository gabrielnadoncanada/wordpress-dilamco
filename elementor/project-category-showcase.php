...
class Project_Category_Showcase extends Widget_Base{    
	    
    public function get_name() {  
        
		return 'control_agency_project_category_showcase';
	}

	public function get_title() {
		return 'Project Category Showcase';
	}
	...
	public function get_keywords() {
		return explode(' ', 'Project Category Showcase Taxonomy');      
	}

    protected function register_controls() {

		$this->start_controls_section(
			'project_category_showcase_section',
			[
				'label' => 'Project Category Showcase',
        ...
        $this->add_control(
			'include',
			[
				'label' => esc_html__( 'Filter By Project Categories', 'architronix' ),
	...
	protected function render() {
		...
		$template_path = get_template_directory() . '/elementor/blocks/project-category-showcase.php';
