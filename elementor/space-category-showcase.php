...
class Space_Category_Showcase extends Widget_Base{    
	    
    public function get_name() {  
        
		return 'control_agency_space_category_showcase';
	}

	public function get_title() {
		return 'Space Category Showcase';
	}
	...
	public function get_keywords() {
		return explode(' ', 'Space Category Showcase Taxonomy');      
	}

    protected function register_controls() {

		$this->start_controls_section(
			'space_category_showcase_section',
			[
				'label' => 'Space Category Showcase',
        ...
        $this->add_control(
			'number',
			[
				'label' => esc_html__( 'Number of categories', 'architronix' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 5,
				'min' => 1,
				'max' => 20,
				'description' => esc_html__( 'Maximum number of categories to display', 'architronix' ),
			]
		);
        ...
        $this->add_control(
			'include',
			[
				'label' => esc_html__( 'Filter By Space Categories', 'architronix' ),
				'type' => Controls_Manager::SELECT2,
				'multiple' => true,
				'options' => $this->get_space_categories(),
				'description' => esc_html__( 'Select specific categories to display', 'architronix' ),
			]
		);
    ...
    private function get_space_categories() {
        $categories = [];
        $terms = get_terms([
            'taxonomy' => 'space_cat',
            'hide_empty' => false,
	...
	protected function render() {
		...
		$template_path = get_template_directory() . '/elementor/blocks/space-category-showcase.php';
