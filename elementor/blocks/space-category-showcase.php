...
$space_terms = get_terms($space_args);
...
<div class="section-full-width swiper-custom-progress position-relative<?php echo esc_attr($additional_class); ?>">
    <div class="swiper space-category-swiper">
        <div class="swiper-wrapper">
            <?php if (!empty($space_terms) && !is_wp_error($space_terms)) : ?>
                <?php foreach ($space_terms as $term) : 
                $featured_image = get_field('feature_image', $term);
            ...
            <?php else : ?>
                <div class="swiper-slide">
                    <p><?php esc_html_e('No Space Categories found.', 'architronix'); ?></p>
                </div>
            <?php endif; ?>
        </div>
        <!-- swiper-wrapper -->
    ...
    <!-- swiper -->
    <div class="container">
        <div class="space-category-swiper-pagination-wrapper">
            <div class="space-category-swiper-pagination"></div>
            <div class="swiper-button-progress">
                <div class="space-category-progress-button-prev">
                ...
                <div class="space-category-progress-button-next">
