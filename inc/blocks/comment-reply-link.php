 ...
 */
function architronix_render_block_core_comment_reply_link( $attributes, $content, $block ) {
 ...
 */
function architronix_register_block_core_comment_reply_link() {
	register_block_type_from_metadata(
		ABSPATH .'wp-includes/blocks/comment-reply-link',
		array(
			'render_callback' => 'architronix_render_block_core_comment_reply_link',
		)
	);
}

add_action( 'init', 'architronix_register_block_core_comment_reply_link' );
