        ...
        <div class="footer-contents">
            <div class="row gy-5 gy-lg-0 align-items-center justify-content-between">
                <div class="col-lg-4">
                    <div>
                        <a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand">
                            <span class="logo">
                            <?php if (!empty(architronix_get_logo_uri('footer_logo'))) : ?>
                                <picture>                    
                                    <img src="<?php echo esc_url(architronix_get_logo_uri('footer_logo')) ?>" alt="<?php bloginfo('Name') ?>" />                    
                                </picture>
                            <?php else : ?>
                        ...
                        <p class="py-10 py-lg-3 mb-0 fw-semibold nav-title"><?php echo esc_html($footer_social_nav_title) ?></p>
                        
                        <?php 
                        $social_links = get_theme_mod('footer_social_links', architronix_footer_default('footer_social_links'));
                        if(!empty($social_links) && is_array($social_links) && get_theme_mod('enable_social_links', false)) :
                        ?>         
                        <ul class="contact-lists list-unstyled mb-0 d-flex flex-wrap">
                            <?php
                ...
                if (get_theme_mod('display_footer_address_1', true)) { 
                    ...
                    $phoneContent = '';
                    $emailContent = '';
                    if (!empty($address_phone) && !empty($address_phone_label)) {
                        $phoneContent = "<p class='mb-0 d-flex align-items-center gap-2'>" . $address_phone_label . "<a href='tel:" . $address_phone . "' class='text-decoration-none link-hover-animation-1'>" . $address_phone . "</a></p>";

                    }
                    if (!empty($address_email) && !empty($address_email_label)) {
                        $emailContent = "<p class='mb-0 d-flex align-items-center gap-2'>" . $address_email_label . "<a href='mailto:" . $address_email . "' class='text-decoration-none link-hover-animation-1'>" . $address_email . "</a></p>";;
                    }
                    ?>
                    <!-- col-4 -->
                ...
                if (get_theme_mod('display_footer_address_2', true)) {
                    ...
                    if (!empty($address_phone2) && !empty($address_phone_label2)) {
                        $phoneContent2 = "<p class='mb-0 d-flex align-items-center gap-2'>$address_phone_label2<a href='tel:$address_phone2' class='text-decoration-none link-hover-animation-1'>$address_phone2</a></p>";
                    }

                    if (!empty($address_email2) && !empty($address_email_label2)) {
                        $emailContent2 = "<p class='mb-0 d-flex align-items-center gap-2'>$address_email_label2<a href='mailto:$address_email2' class='text-decoration-none link-hover-animation-1'>$address_email2</a></p>";
                    }
                    ?>
                    <!-- col-3 -->
                    <div class="col-lg-4 col-xxl-3">
