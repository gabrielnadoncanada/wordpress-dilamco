<header class="section-header header-1 architronix-nav sticky-navbar header-tra-dark fixed-top">
	<div class="container">
	<nav class="navbar navbar-style-2 navbar-expand-xl navbar-light architronix-navbar nav-border hover-menu" aria-label="Offcanvas navbar large">	
				
			<a href="<?php echo esc_url(home_url('/')); ?>" class="navbar-brand">
				<picture class="logo logo-dark logo-primary">
					<?php echo architronix_get_custom_logo(); ?>
				</picture>
				<picture class="logo logo-white logo-sticky">
					<?php echo architronix_get_custom_logo('custom_logo_white', 'assets/images/logo-white.svg'); ?>
				</picture>
			</a> 
			...
			<?php
			$navbar_icons = architronix_get_header_elements('navbar_icons', '<li class="nav-item d-flex flex-wrap">', '</li>');
			wp_nav_menu([
				'container' => 'div',
				...
				'depth' => 2,
				'items_wrap'      => '<ul id="%1$s" class="%2$s">%3$s'.$navbar_icons.'</ul>',
